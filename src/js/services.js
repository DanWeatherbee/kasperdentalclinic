   ...
   var contentPart3 =
       ...
       '<p>Chewing ability &ndash; this is drastically improved by replacing toothless areas with denture teeth.' +
       ' The ability to chew well contributes to overall health and nutrition, as well as improved food enjoyment.</p>' +
       '<p>Aesthetics &ndash; the presence of teeth provide a natural facial appearance; and wearing a denture' +
       ...
       '<p>The first time you are fitted with a denture, you should notice a distinct improvement on your smile.' +
       ...
       '<p>Lisping, or &ldquo;thick speech&rdquo; can also happen at first as your tongue learns the' +
       ' slightly new positions of your new teeth. &nbsp;With practice, ' + 'this will clear up in a short period of time.</p>' +
       '<p>A very few patients experience a temporary gag sensation for the first few days of denture ' +
       ...
       '<p>As the denture settles into place over the first days and weeks of use, you may notice areas' +
       ...
       '<p>It will usually take about 6-8 weeks of wear to become completely acclimatized to wearing dentures,' +
       ...
       '<p>The human mouth is a living set of tissues that are subject to constant change over time. &nbsp;' +
       ...
       '<p>Come on in and we can discuss your options!</p>' +
       '</div>' +
       '</li>' +
       '</div>' +
       '</div>' +
   ...
   $('body').append(parallax);
   $('body').append(contentPart2);
   $('body').append(contentPart3);
   $('body').append(contentPart4);
