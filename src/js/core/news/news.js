var contentNews = '<section class="container" id="content-news">' +
    ...
    '<section class="row">' +
    '<div class="col-lg-6">' +
    '<a href="http://www.velscope.com/"><img class="card-image animated zoomInDown" src="images/small/velscop.jpg" alt="velscop.jpg" /></a>' +
    '</div>' +
    '<div class="col-lg-6">' +
    ...
    ' With two clinics and a satellite office,' +
    ' we’ll bring back that smile and confidence quickly and conveniently.' +
