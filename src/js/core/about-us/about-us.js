  var contentMain = '<section class="container" id="about-content">' +
      ...
      '<p class="header-text animated slideInLeft">Thank you for choosing our office for your denture needs.' +
      ...
      '<p class="card-text animated slideInLeft">Card Demo Content text goes here...</p>' +
