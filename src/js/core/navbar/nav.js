   var contentNav = '<nav class="navbar navbar-fixed-top caps" id="topnav1" role="navigation">' +
       ...
       '<div style="font-size:12px;line-height:13px">DENTURE CLINIC LTD --  admin-beta on about page.</div>' +
       '</a>' +
       '</div>' +
       ...
       '<li class="fadeOutDown" id="nav2b"><a href="suction-denture.html">Suction Dentures </a></li>' +
