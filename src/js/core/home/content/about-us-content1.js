...
// cols
var aboutMainContent1Row1Col1 = '<article class="col-xs-1 col-sm-2" id="about-main-row1-col1"></article>';
var aboutMainContent1Row1Col2 = '<article class="col-xs-10 col-sm-8" id="about-main-row1-col2"></article>';
var aboutMainContent1Row1Col3 = '<article class="col-xs-1 col-sm-2" id="about-main-row1-col3"></article>';
// tags
var aboutMainContent1Row1Col2HeaderH1Tag = '<h1 id="about-main-row1-col2-header-h1-tag" class="text-center"></h1>';
