...
app.editIndexHeaderImgJason = function(
    ...
    var self = this;
    // Header H2 Controls =============================================
    self.editHeaderImgSrcBtn = '<i type="button" class="fa fa-edit edit-btns" id="edit-header-img-src-btn" onclick="app.editHeaderImgSrc()"> - img</i>';
    self.saveHeaderImgSrcBtn = '<i type="button" class="fa fa-save edit-btns" id="save-header-img-src-btn" onclick="app.saveHeaderImgSrc()"></i>';
    self.textAreaIndexImgSrc = '<textarea class="form-control" rows="1" number="3" maxlength="100" ' +
    ...
    app.saveHeaderImgSrc = function() {
        ...
        self.indexContentObj.main.content1[0].indexMainContent1Row1Col2Img = '<img class="gradient img-thumbnail img-responsive center-block" ' +
            'src="' +
            self.indexContentObj.main.content1[0].indexMainContent1Row1Col2ImgSrc +
        ...
        $('#index-main-row1-col2-header-h2-tag').prepend(self.indexContentObj.main.content1[0].indexMainContent1Row1Col2Img);
