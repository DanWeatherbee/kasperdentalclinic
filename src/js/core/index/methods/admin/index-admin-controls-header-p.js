...
app.editindexHeaderPText = function(
    ...
    var self = this;
    // Header Controls =============================================
    self.$PTag = $('#index-main-row1-col2-p-tag');
    ...
    app.saveHeaderPText = function() {
        ...
        console.log(self.indexContentObj.main.content1)
        self.indexContentObj.main.content1[6].row1Col2PTagText = usrInput;
        self.$PTag.html(self.indexContentObj.main.content1[6].row1Col2PTagText);
