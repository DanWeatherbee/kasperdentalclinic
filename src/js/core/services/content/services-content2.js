...
var servicesMainContent2Row2ParallaxContainerQuoteBoxIconRight = '<i class="fa fa-quote-right" id="services-parallax-icon-right"></i>';
var servicesMainContent2ParallaxRow2Col1PTag = '<p class="animated slideInLeft" id="services-main-row2-parallax-col1-p-tag"></p>';
var servicesMainContent2ParallaxRow2Col1PTagText = ' Thank you so much for my new smile,<br />' +
