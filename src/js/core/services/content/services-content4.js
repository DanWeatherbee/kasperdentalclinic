...
var servicesCollapsibleContainersFaq1 = '<section class="services-collapse-containers" id="services-collapsible-containers-faq-1"' +
    ...
    '<p id="services-collapsible-p-tag-faq-1">' +
    '</p>' +
    '</article>' +
    '</section>';
...
var servicesCollapsibleContainersPTextFaq1 = 'Chewing ability;' +
    ...
    ' The ability to chew well contributes to overall health and nutrition, as well as improved food enjoyment.' +
    '<br /><br />' +
    'Aesthetics; the presence of teeth provide a natural facial appearance.' +
    ' Wearing a denture to replace missing teeth provides support for the lips and cheeks,' +
    ' preventing the collapsed appearance that can often occur after losing teeth.' +
    '<br /><br />' +
    'Speech; replacing missing teeth especially the front teeth, patients are better able' +
    ' to pronounce those words containing sibilants or fricatives' +
    ' (sounds that require teeth, i.e. fifty, stilts, or tent).' +
    '<br /><br />' +
...
var servicesCollapsibleContainersFaq2 = '<section class="services-collapse-containers" id="services-collapsible-containers-faq-2"' +
    ...
    '<p id="services-collapsible-p-tag-faq-2">' +
    '</p>' +
    '</article>' +
    '</section>';
...
var servicesCollapsibleContainersPTextFaq2 = 'The first time you are fitted with a denture,' +
    ...
    ' you may experience excess saliva for 12 to 48 hours as your brain adapts to the new feel of your denture.' +
    '<br /><br />' +
    'Lisping, or thick speech can also happen at first as your tongue learns the slightly new positions of your new teeth.' +
    ' With practice this will clear up in a short period of time.' +
    ' A very few patients experience a temporary gag sensation.' +
    '<br /><br />' +
    'This may occur during the first few days of denture wear,' +
    ' due to the unfamiliar feeling of the denture on your palate.' +
    ' In the unlikely event that this bothers you for longer a couple of days,' +
    ' adjustments can be made to shorten the palate part of your denture.' +
    '<br /><br />' +
    'As the denture settles into place over the first days and weeks of use,' +
    ' you may notice areas of pressure or sore spots.' +
    ' This is normal, and will be corrected at adjustment appointments,' +
    ' until your denture fits as comfortably as possible.' +
    '<br /><br />' +
...
var servicesCollapsibleContainersFaq3 = '<section class="services-collapse-containers" id="services-collapsible-containers-faq-3"' +
    ...
    '<p id="services-collapsible-p-tag-faq-3">' +
    '</p>' +
    '</article>' +
    '</section>';
...
var servicesCollapsibleContainersFaq4 = '<section class="services-collapse-containers" id="services-collapsible-containers-faq-4"' +
    ...
    '<p id="services-collapsible-p-tag-faq-4">' +
    '</p>' +
    '</article>' +
    '</section>';
...
var servicesCollapsibleContainersPTextFaq4 = 'The human mouth is a living set of tissues' +
    ...
    ' If this occurs there are several things we can do to repair, reline, or replace the denture for you.' +
